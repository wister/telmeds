		...
		<div class="wrapper">
			<div id="singletext" class="contenedor">
				<ul id="singletxt">
					...
					<li class="ui-tabs-selected"><a href="#item-1">Casos Clínicos</a></li>
				</ul>
				<div class="colabdiv">
					<h1>Archivo de Casos Clínicos de Telmeds.org</h1>
<?php $odd_or_even = 'odd'; ?>
<?php $temp = $wp_query; $wp_query= null; $wp_query = new WP_Query(); $wp_query->query('post_type=casos&order=ASC&orderby=title&showposts=10'.'&paged='.$paged); ?>
