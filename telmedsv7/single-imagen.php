...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				<ul id="singletxt">
					...
					<p class="derecho"><a href="<?php bloginfo('url');?>/imagen-medica/">Archivo de Imagénes Médicas</a></p>
				</ul>
...
?>
					<a href="<?php echo get_post_meta ($post->ID, 'IMS_imagen', true);?>"><img class="ims" src="<?php bloginfo('template_directory'); ?>/scripts/timthumb.php?src=<?php echo get_post_meta ($post->ID, 'IMS_imagen', true);?>&amp;zc=1&amp;w=900" alt="<?php the_title(); ?>" /></a>
<?php the_content(); ?>
